...
def _static_contract_checks(args: argparse.Namespace) -> list[ValidationCheck]:
    commands = (
        ("openapi_contract", [sys.executable, "scripts/quality/openapi_quality_gate.py"]),
        (
            "api_vocabulary_contract",
            [sys.executable, "scripts/quality/api_vocabulary_inventory.py", "--validate-only"],
        ),
        (
            "route_family_contract",
            [sys.executable, "scripts/quality/route_contract_family_guard.py"],
        ),
        (
            "source_data_product_contract",
            [sys.executable, "scripts/quality/source_data_product_contract_guard.py"],
        ),
        (
            "domain_product_contract",
            [sys.executable, "scripts/validation/validate_domain_data_product_contracts.py"],
        ),
    )
    return [
