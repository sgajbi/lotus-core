...
GUARD_COMMAND = "python scripts/generators/generate_api_route_catalog.py --check"
...
def validate_catalog(payload: dict[str, Any], generated: dict[str, Any]) -> list[str]:
    ...
    if payload != generated:
        errors.append(
            "API route catalog is not current; run "
            "python scripts/generators/generate_api_route_catalog.py"
        )
    return errors
