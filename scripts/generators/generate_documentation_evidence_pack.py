...
def _validate_supported_features() -> DocumentationEvidenceCheck:
    return _run_command(
        ...
        command=[sys.executable, "scripts/quality/supported_features_guard.py"],
        artifact_paths=(
            REPO_ROOT
            / "contracts"
            / "supported-features"
...
def _validate_runbooks() -> DocumentationEvidenceCheck:
    ...
    incident_playbook_check = _run_command(
        ...
        command=[sys.executable, "scripts/quality/incident_playbook_guard.py"],
...
def run_documentation_evidence(args: argparse.Namespace) -> dict[str, Any]:
    ...
    checks = [
        ...
        _run_command(
            ...
            command=[sys.executable, "scripts/quality/wiki_validation_guard.py"],
        ),
        _run_command(
            name="front_door_sync_check",
            command=[sys.executable, "scripts/quality/front_door_sync_guard.py"],
        ...
        _run_command(
            ...
            command=[sys.executable, "scripts/generators/generate_api_route_catalog.py", "--check"],
        ...
        _run_command(
            ...
            command=[sys.executable, "scripts/quality/rfc0083_closure_guard.py"],
        ),
        _run_command(
            name="rfc_status_ledger_check",
            command=[sys.executable, "scripts/quality/rfc_status_ledger_guard.py"],
        ),
