...
SUITES: dict[str, list[str]] = {
    ...
    "unit-db": [
        ...
        "tests/integration/test_analytics_export_job_tenant_migration.py",
        ...
        "test_portfolio_party_role_postgresql.py",
    ],
    ...
    "transaction-buy-contract": [
        ...
        "tests/integration/services/portfolio_transaction_processing_service/test_int_cost_repository_lot_offset.py",
    ...
    "transaction-fx-contract": [
        ...
        "tests/unit/services/portfolio_transaction_processing_service/domain/transaction/fx/test_contract_instrument.py",
        "tests/unit/services/portfolio_transaction_processing_service/domain/transaction/test_processing_type.py",
        "tests/unit/services/portfolio_transaction_processing_service/domain/cost_basis/calculation/test_cost_calculator.py",
        "tests/unit/services/portfolio_transaction_processing_service/application/cost_basis_processing/test_execution.py",
        "tests/unit/services/portfolio_transaction_processing_service/application/cost_basis_processing/test_effect_coordination.py",
        "tests/unit/services/portfolio_transaction_processing_service/domain/cashflow/test_calculation.py",
