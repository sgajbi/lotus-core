...
| Ruff format | 125 files still require formatting under `python -m ruff format --check .` after CR-858 | Ratchet in bounded batches, then enforce a format gate once clean |
