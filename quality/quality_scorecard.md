...
- `make monetary-float-guard` => previously passed in the CR-1034 snapshot; current CR-1191
  follow-up rerun fails on non-monetary duration/settings conversions in
  `portfolio_common/outbox_dispatcher.py` and `ingestion_service/app/settings.py`
