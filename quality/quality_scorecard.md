...
| Ruff format | 110 files still require formatting under `python -m ruff format --check .` after CR-859 | Ratchet in bounded batches, then enforce a format gate once clean |
