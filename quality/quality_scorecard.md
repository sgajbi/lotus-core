...
| Ruff format | 141 files still require formatting under `python -m ruff format --check .` after CR-857 | Ratchet in bounded batches, then enforce a format gate once clean |
