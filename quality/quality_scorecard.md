...
| Ruff format | 40 files still require formatting under `python -m ruff format --check .` after CR-863 | Ratchet in bounded batches, then enforce a format gate once clean |
