...
| Ruff findings | 251 total; unused-symbol and import-order subsets are clean | Zero new findings, then ratchet existing line-length and import-position findings down |
