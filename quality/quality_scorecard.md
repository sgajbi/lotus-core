...
| Ruff format | 21 files still require formatting under `python -m ruff format --check .` after CR-864 | Ratchet in bounded batches, then enforce a format gate once clean |
