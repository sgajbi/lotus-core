...
- CR-1083 focused evidence: Main Releasability run `27459725250` passed every lane except
  ...
  checks, passes `git diff --check`, and keeps runtime-scope unit guard tests green with 12 tests.
  The exact Docker-backed integration regression could not run locally because Docker Desktop is
