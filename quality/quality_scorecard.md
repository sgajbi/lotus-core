...
| Ruff format | 90 files still require formatting under `python -m ruff format --check .` after CR-860 | Ratchet in bounded batches, then enforce a format gate once clean |
