...
- Current measured source hotspots: `reference_data_dto.py` `B (9.31)` and
  `ingestion_job_service.py` `B (15.15)`; active non-generated C-ranked source hotspot list is
  clear.
