...
| Ruff format | 52 files still require formatting under `python -m ruff format --check .` after CR-862 | Ratchet in bounded batches, then enforce a format gate once clean |
