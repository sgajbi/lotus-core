...
| Complexity | Average `A (2.97)` with D/E/F hotspots still present; Xenon enforcement remains report-only after CR-879 because current source has F-ranked blocks | Reduce existing D/E/F hotspots by domain priority before promoting a broad complexity gate |
