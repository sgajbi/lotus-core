...
| CI governance | PR Merge Gate and Main Releasability no longer pin the Node 20-deprecated `actions/cache@v4`, `actions/upload-artifact@v4`, `actions/download-artifact@v4`, or `docker/setup-buildx-action@v3`; CR-1079 pins the current major action versions and adds a unit regression test | Keep action runtime warnings clean through workflow lint and pinned-version tests |
