...
| Equity and fund distributions | Ordinary dividend | `limited` | Complete withholding, return-of-capital, basis reduction, and timing are owned by [#448](https://github.com/sgajbi/lotus-core/issues/448). |
