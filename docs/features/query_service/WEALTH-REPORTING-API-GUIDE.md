...
matches the latest position quantity in the active epoch. Other reporting endpoints continue to
apply their own snapshot predicates. This keeps each query bounded while
