...
|---|---|---|---|---|
| 4. SELL Semantic Invariants | COVERED | MATCHES | `tests/unit/services/portfolio_transaction_processing_service/domain/cost_basis/calculation/test_cost_calculator.py`, `tests/unit/transaction_specs/test_sell_slice0_characterization.py` | SELL proceeds, consumed quantity, and disposal sign invariants are test-enforced. |
...
| 6. SELL Canonical Data Model | COVERED | MATCHES | `tests/unit/services/ingestion_service/test_transaction_model.py`, `tests/unit/services/portfolio_transaction_processing_service/domain/transaction/test_booking_metadata.py` | Canonical SELL metadata, linkage fields, and policy metadata are preserved end-to-end. |
...
| 8. SELL Calculation Rules and Formulas | COVERED | MATCHES | `tests/unit/services/portfolio_transaction_processing_service/domain/cost_basis/calculation/test_cost_calculator.py` | Realized P&L and proceeds/cost basis invariants enforced with deterministic error semantics. |
