...
| 7. BUY Validation Rules | COVERED | MATCHES | `tests/unit/services/portfolio_transaction_processing_service/transaction/test_trade_validation.py`, `docs/rfc-transaction-specs/transactions/BUY/BUY-SLICE-1-VALIDATION-REASON-CODES.md` | Deterministic reason codes and strict metadata validation are implemented. |
