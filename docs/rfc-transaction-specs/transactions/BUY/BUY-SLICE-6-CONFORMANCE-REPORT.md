...
|---|---|---|---|---|
| 4. BUY Semantic Invariants | COVERED | MATCHES | `tests/unit/services/portfolio_transaction_processing_service/cost/test_cost_calculator.py`, `tests/unit/transaction_specs/test_buy_slice0_characterization.py` | BUY quantity/cost progression and explicit zero realized P&L locked in tests. |
...
| 8. BUY Calculation Rules and Formulas | COVERED | MATCHES | `tests/unit/services/portfolio_transaction_processing_service/cost/test_cost_calculator.py` | Calculation invariants and cross-currency rules are enforced. |
...
| 19. BUY Configurable Policies | COVERED | MATCHES | `tests/unit/services/portfolio_transaction_processing_service/cost/test_cost_calculator.py` | BUY policy hook coverage exists for accrued-interest exclusion policy. |
