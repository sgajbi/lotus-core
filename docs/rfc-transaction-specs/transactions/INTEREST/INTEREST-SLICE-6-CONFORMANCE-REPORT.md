...
- `python -m pytest -q tests/unit/services/portfolio_transaction_processing_service/domain/transaction/validation/test_income.py`
...
- `python -m pytest -q tests/unit/services/portfolio_transaction_processing_service/domain/transaction/test_booking_metadata.py`
- `python -m pytest -q tests/unit/services/portfolio_transaction_processing_service/domain/cost_basis/calculation/test_cost_calculator.py -k "interest or dividend"`
