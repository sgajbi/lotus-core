...
4. Simulation DTOs
5. Lookup/catalog DTOs
6. Operations support/lineage DTOs
...
4. `tests/unit/services/query_service/services/test_integration_service.py`
5. `tests/unit/services/query_service/services/test_simulation_service.py`
