...
`portfolio_derived_state_service.app.application.aggregation_jobs.scheduler` owns:
...
`portfolio_derived_state_service.app.application.aggregation_jobs.processor` owns:
...
`portfolio_derived_state_service.app.infrastructure.aggregation_scheduler_adapters` owns concrete
