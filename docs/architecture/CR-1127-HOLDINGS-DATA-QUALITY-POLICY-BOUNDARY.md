...
`position_response_data` remains a C-ranked response assembly hotspot and
`merge_snapshot_and_history_position_rows` remains B-ranked; both should be addressed separately
with focused API-facing proof.
