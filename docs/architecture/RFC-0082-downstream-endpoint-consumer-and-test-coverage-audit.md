...
| `#254` fresh seeded analytics windows do not mature beyond day one | This remains a runtime readiness/maturation defect rather than a route-publication gap. | Keep open until fresh canonical/live validation is re-run and captured. |
