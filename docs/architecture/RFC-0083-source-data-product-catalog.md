...
| `ReconciliationEvidenceBundle` | Control-plane and policy | `query_control_plane_service` | performance, risk, gateway, manage | `/support/reconciliation-runs`, `/support/reconciliation-findings` |
...
| `IngestionEvidenceBundle` | Control-plane and policy | `query_control_plane_service` | gateway, manage, report | `/support/lineage-keys`, `/support/replay-keys`, `/ingestion-health/readiness` |
