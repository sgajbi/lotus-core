...
| `position_calculator_service` | Position history and snapshot materialization | `position_history`, `daily_position_snapshots`, `position_state` | `transaction_processing_completed` | `daily_position_snapshot_persisted`, `transactions_reprocessing_requested` | Event |
