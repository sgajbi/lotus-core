...
| Replay request path | required | CR-1450 through CR-1454 implement the use case, port, adapter, delivery, and final two-consumer composition without runtime activation. Add end-to-end replay/order/duplicate/epoch/backlog proof. | Replay ordering, duplicate, partial-publish, epoch, throttle, and backlog tests pass. |
