...
| Aggregate observability | required | CR-1457 makes task exits attributable and CR-1458 proves target DB/Kafka/runtime readiness plus build metadata. Add module outcome/error/latency metrics, consumer lag, DB/Kafka/outbox diagnostics, traces, and final support runbook. | Observability contract and failure-injection tests pass. |
