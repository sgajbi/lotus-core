...
| Replay request path | required | CR-1450 through CR-1455 implement the path and prove duplicate semantic parity without runtime activation. Add epoch/backdated replay, publisher failure recovery, ordering, throttle, and backlog proof. | Replay ordering, duplicate, partial-publish, epoch, throttle, and backlog tests pass. |
