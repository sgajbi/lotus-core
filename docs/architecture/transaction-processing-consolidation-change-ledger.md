...
| Aggregate observability | required | CR-1457 makes consumer/dispatcher/server task exits attributable. Add module outcome/error/latency metrics, target health contract proof, consumer lag, DB/Kafka/outbox diagnostics, traces, and final support runbook. | Observability contract and failure-injection tests pass. |
