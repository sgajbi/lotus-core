...
6. Added `scripts/quality/repository_transaction_boundary_guard.py` and unit tests.
...
2. `python scripts/quality/repository_transaction_boundary_guard.py`
3. `python scripts/quality/application_port_catalog_guard.py`
