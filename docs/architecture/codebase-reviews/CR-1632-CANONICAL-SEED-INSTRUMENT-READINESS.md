...
- branch-qualified live reseed against the owned `lotus-core-app-local` stack passed the former
  instrument-eligibility foreign-key failure and restored the governed portfolio; final readiness,
  PR CI, merge, and exact-main certification remain required before closure

Signed implementation commits: `14726920a`, `1008a6150`, and `c7b9feb52`.
