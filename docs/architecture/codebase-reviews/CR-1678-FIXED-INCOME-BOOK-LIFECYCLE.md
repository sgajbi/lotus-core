...
- correction field-presence hardening: semantic correction now owns one explicit set covering
  ...
  41 warning-strict unit cases and one restarted, repeated-repair PostgreSQL lifecycle passed in
  64.34 seconds, covering positive-to-omitted, positive-to-zero, cash retirement/regeneration,
  immutable receipt-version neutrality, unrelated-row isolation, query DTOs, P&L, and lineage.
