...
1. Added release-evidence assertions to `scripts/release/write_image_release_manifest.py`.
...
3. `python -m ruff check scripts/release/write_image_release_manifest.py tests/unit/scripts/test_write_image_release_manifest.py --ignore E501,I001`
4. `python -m ruff format --check scripts/release/write_image_release_manifest.py tests/unit/scripts/test_write_image_release_manifest.py`
