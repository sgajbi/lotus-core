...
Booked `cashflows.cashflow_date` values are generated by Core's cashflow-date policy before this
product reads them. Settlement-dated cash movements, dividend/interest cash effects, FX cash
