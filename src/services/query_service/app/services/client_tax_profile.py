...
from .reference_data_mappers import client_tax_profile_entry
from .request_fingerprint import request_fingerprint


async def resolve_client_tax_profile_response(
    *,
    repository: Any,
    portfolio_id: str,
    ...
    rows = await repository.list_client_tax_profiles(
        portfolio_id=portfolio_id,
...
def build_client_tax_profile_response(
    *,
    portfolio_id: str,
    binding: Any,
    request: ClientTaxProfileRequest,
