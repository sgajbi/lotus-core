...
class SqlAlchemyAccruedIncomeOffsetRepository:
    ...
    async def upsert_accrued_income_offset(
        ...
        await self._session.execute(accrued_income_offset_upsert_statement(transaction))


def accrued_income_offset_upsert_statement(transaction: CostBasisTransaction) -> Insert:
    """Build the canonical idempotent purchase-income-offset write."""
    ...
    payload = {
        ...
        "linked_transaction_group_id": getattr(transaction, "linked_transaction_group_id", None),
