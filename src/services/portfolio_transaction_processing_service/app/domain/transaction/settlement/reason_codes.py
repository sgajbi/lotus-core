...
class SettlementCashRejectionReasonCode(StrEnum):
    ...
    DIVIDEND_NEGATIVE_WITHHOLDING_TAX = "DIVIDEND_014_NEGATIVE_WITHHOLDING_TAX"
    DIVIDEND_WITHHOLDING_EXCEEDS_GROSS_AMOUNT = "DIVIDEND_015_WITHHOLDING_EXCEEDS_GROSS_AMOUNT"
    ...
    REDEMPTION_NON_POSITIVE_NET_SETTLEMENT = "REDEMPTION_017_NON_POSITIVE_NET_SETTLEMENT"
