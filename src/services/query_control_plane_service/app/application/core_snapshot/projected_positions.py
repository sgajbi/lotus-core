"""Apply proposed transaction effects to baseline snapshot positions."""
...
def new_projected_position(security_id: str, instrument: CoreSnapshotInstrument) -> dict[str, Any]:
    return {
...
def change_quantity_effect(change: SimulationChange) -> Decimal:
    return cast(
        Decimal,
