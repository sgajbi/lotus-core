"""Application orchestration for analytics inputs and durable exports."""
...
class AnalyticsRuntimePolicy:
    ...
    export_stale_timeout_minutes: int
...
class AnalyticsTimeseriesService:
    ...
    def __init__(
        ...
        *,
        ...
        self._page_token_secret = policy.page_token_secret
        self._page_token_key_id = policy.page_token_key_id
        self._page_token_previous_keys = dict(policy.page_token_previous_keys)
