"""Assemble the governed operational support overview."""

from dataclasses import dataclass
from datetime import date, datetime
from typing import Any

from ...contracts.operations import SupportOverviewResponse
...
class SupportOverviewSnapshot:
    ...
    latest_reconciliation_run: ReconciliationRunEvidence | None
