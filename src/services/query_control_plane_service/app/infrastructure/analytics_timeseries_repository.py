"""SQLAlchemy reader for portfolio analytics source evidence."""
...
def currency_code_sql_expr(currency_code_column: Any):
    """Normalize a persisted currency column for case-insensitive ISO-code predicates."""
...
class AnalyticsTimeseriesRepository:
    ...
    async def get_portfolio(self, portfolio_id: str) -> PortfolioAnalyticsSource | None:
        ...
        if row is None:
            return None
        return PortfolioAnalyticsSource(
