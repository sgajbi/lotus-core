...
PortfolioIdPath = Annotated[
    str,
    Path(
        description="Portfolio identifier governed by the admitted tenant.",
...
@router.get(
    ...
    responses={403: tenant_forbidden_response("IntegrationPolicy")},
...
@router.post(
    ...
    responses={
        403: tenant_forbidden_response("PortfolioTaxLotWindow"),
...
@router.post(
    ...
    responses={
        403: tenant_forbidden_response("TransactionCostCurve"),
        404: problem_response(
            "Portfolio not found",
...
@router.post(
    ...
    responses={
        403: tenant_forbidden_response("PerformanceComponentEconomics"),
        404: problem_response(
            "Portfolio not found",
...
@router.post(
    ...
    responses={
        403: tenant_forbidden_response("DpmSourceReadiness"),
        422: problem_response(
...
@router.post(
    ...
    responses={
        status.HTTP_403_FORBIDDEN: tenant_forbidden_response("DiscretionaryMandateBinding"),
        status.HTTP_404_NOT_FOUND: problem_response(
...
async def resolve_discretionary_mandate_binding(
    ...
    http_request: Request,
    portfolio_id: PortfolioIdPath,
    dpm_source_service: DpmSourceReadinessService = Depends(get_dpm_source_readiness_service),
) -> DiscretionaryMandateBindingResponse:
    request = bind_tenant_request(request, http_request, "DiscretionaryMandateBinding")
    response = cast(
...
@router.post(
    ...
    responses={
        status.HTTP_403_FORBIDDEN: tenant_forbidden_response("ClientRestrictionProfile"),
        status.HTTP_404_NOT_FOUND: problem_response(
            "No effective discretionary mandate binding found.",
...
async def get_client_restriction_profile(
    ...
    request = bind_tenant_request(request, http_request, "ClientRestrictionProfile")
...
@router.post(
    ...
    responses={
        status.HTTP_403_FORBIDDEN: tenant_forbidden_response("SustainabilityPreferenceProfile"),
        status.HTTP_404_NOT_FOUND: problem_response(
            "No effective discretionary mandate binding found.",
...
async def get_sustainability_preference_profile(
    ...
    request = bind_tenant_request(request, http_request, "SustainabilityPreferenceProfile")
...
@router.post(
    ...
    responses={
        status.HTTP_403_FORBIDDEN: tenant_forbidden_response("ClientTaxProfile"),
        status.HTTP_404_NOT_FOUND: problem_response(
            "No effective discretionary mandate binding found.",
...
async def get_client_tax_profile(
    ...
    request = bind_tenant_request(request, http_request, "ClientTaxProfile")
...
@router.post(
    ...
    responses={
        status.HTTP_403_FORBIDDEN: tenant_forbidden_response("ClientTaxRuleSet"),
        status.HTTP_404_NOT_FOUND: problem_response(
            "No effective discretionary mandate binding found.",
...
async def get_client_tax_rule_set(
    ...
    request = bind_tenant_request(request, http_request, "ClientTaxRuleSet")
...
@router.post(
    ...
    responses={
        status.HTTP_403_FORBIDDEN: tenant_forbidden_response("ClientIncomeNeedsSchedule"),
        status.HTTP_404_NOT_FOUND: problem_response(
            "No effective discretionary mandate binding found.",
...
async def get_client_income_needs_schedule(
    ...
    request = bind_tenant_request(request, http_request, "ClientIncomeNeedsSchedule")
...
@router.post(
    ...
    responses={
        status.HTTP_403_FORBIDDEN: tenant_forbidden_response("LiquidityReserveRequirement"),
        status.HTTP_404_NOT_FOUND: problem_response(
            "No effective discretionary mandate binding found.",
...
async def get_liquidity_reserve_requirement(
    ...
    request = bind_tenant_request(request, http_request, "LiquidityReserveRequirement")
...
@router.post(
    ...
    responses={
        status.HTTP_403_FORBIDDEN: tenant_forbidden_response("PlannedWithdrawalSchedule"),
        status.HTTP_404_NOT_FOUND: problem_response(
            "No effective discretionary mandate binding found.",
...
async def get_planned_withdrawal_schedule(
    ...
    request = bind_tenant_request(request, http_request, "PlannedWithdrawalSchedule")
...
@router.post(
    ...
    responses={
        status.HTTP_403_FORBIDDEN: tenant_forbidden_response("ExternalHedgePolicy"),
        status.HTTP_404_NOT_FOUND: problem_response(
            "No effective discretionary mandate binding found.",
...
async def get_external_hedge_policy(
    ...
    request = bind_tenant_request(request, http_request, "ExternalHedgePolicy")
...
@router.post(
    ...
    responses={
        status.HTTP_403_FORBIDDEN: tenant_forbidden_response("ExternalHedgeExecutionReadiness"),
        status.HTTP_404_NOT_FOUND: problem_response(
            "No effective discretionary mandate binding found.",
...
async def get_external_hedge_execution_readiness(
    ...
    request = bind_tenant_request(request, http_request, "ExternalHedgeExecutionReadiness")
...
@router.post(
    ...
    responses={
        status.HTTP_403_FORBIDDEN: tenant_forbidden_response(
...
async def get_external_order_execution_acknowledgement(
    ...
    request = bind_tenant_request(request, http_request, "ExternalOrderExecutionAcknowledgement")
...
@router.post(
    ...
    responses={
        status.HTTP_403_FORBIDDEN: tenant_forbidden_response("ExternalCurrencyExposure"),
        status.HTTP_404_NOT_FOUND: problem_response(
            "No effective discretionary mandate binding found.",
...
async def get_external_currency_exposure(
    ...
    request = bind_tenant_request(request, http_request, "ExternalCurrencyExposure")
...
@router.post(
    ...
    responses={
        status.HTTP_403_FORBIDDEN: tenant_forbidden_response("ExternalEligibleHedgeInstrument"),
        status.HTTP_404_NOT_FOUND: problem_response(
            "No effective discretionary mandate binding found.",
...
async def get_external_eligible_hedge_instruments(
    ...
    request = bind_tenant_request(request, http_request, "ExternalEligibleHedgeInstrument")
