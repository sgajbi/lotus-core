...
@router.post(
    ...
    description=(
        ...
        "Use it for deterministic core-state execution projection only. Do not use it for "
        "generic simulation-session lifecycle orchestration, gateway workspace reads, or "
        "advisory recommendation ownership. "
