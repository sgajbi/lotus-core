...
from .exception_mappers import register_query_control_plane_exception_handlers
from .routers import (
    advisory_simulation,
    analytics_inputs,
    capabilities,
...
health_router = create_health_router("db", service_name=SERVICE_NAME, app_version=app.version)
include_routers(
    app,
    health_router,
    operations.router,
...
register_query_control_plane_exception_handlers(app, logger=logger)
