...
EVENT_FAMILY_DEFINITIONS: tuple[EventFamilyDefinition, ...] = (
    ...
    EventFamilyDefinition(
        ...
        topic="position.snapshot.persisted",
    ...
    EventFamilyDefinition(
        ...
        topic="portfolio.pipeline.transaction_processing.completed",
    ...
    EventFamilyDefinition(
        ...
        direction=INTERNAL_EVENT,
        aggregate_type="portfolio_day",
        topic="portfolio.pipeline.valuation.ready",
        producer_service="pipeline_orchestrator_service",
        consumer_services=("valuation_service",),
        idempotency_required=True,
        correlation_required=True,
    ...
    EventFamilyDefinition(
        ...
        direction=INTERNAL_EVENT,
        aggregate_type="portfolio_day",
        topic="portfolio.pipeline.valuation.completed",
        producer_service="valuation_service",
        consumer_services=("position_timeseries_service",),
        idempotency_required=True,
        correlation_required=True,
    ...
    EventFamilyDefinition(
        ...
        direction=INTERNAL_EVENT,
        aggregate_type="portfolio_day",
        topic="portfolio.pipeline.position_timeseries.completed",
    ...
    EventFamilyDefinition(
        ...
        direction=INTERNAL_EVENT,
        aggregate_type="portfolio_day",
        topic="portfolio.pipeline.aggregation.completed",
    ...
    EventFamilyDefinition(
        ...
        direction=INTERNAL_EVENT,
        aggregate_type="portfolio_day",
        topic="portfolio.reconciliation.requested",
        producer_service="pipeline_orchestrator_service",
    ...
    EventFamilyDefinition(
        ...
        direction=INTERNAL_EVENT,
        aggregate_type="portfolio_day",
        topic="portfolio.reconciliation.completed",
    ...
    EventFamilyDefinition(
        ...
        direction=INTERNAL_EVENT,
        aggregate_type="portfolio_day",
        topic="portfolio.controls.evaluated",
        producer_service="pipeline_orchestrator_service",
