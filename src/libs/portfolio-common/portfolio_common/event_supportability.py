...
EVENT_FAMILY_DEFINITIONS: tuple[EventFamilyDefinition, ...] = (
    ...
    EventFamilyDefinition(
        ...
        consumer_services=("valuation_orchestrator_service",),
        idempotency_required=True,
        correlation_required=True,
        schema_version_required=True,
        supportability_evidence=(INGESTION_EVIDENCE_BUNDLE,),
    ...
    EventFamilyDefinition(
        ...
        schema_model="FxRatePersistedEvent",
        family=DOMAIN_STATE_EVENT,
        direction=OUTBOUND_EVENT,
    ...
    EventFamilyDefinition(
        ...
        producer_service="position_valuation_calculator",
        consumer_services=("portfolio_derived_state_service",),
        idempotency_required=True,
        correlation_required=True,
        schema_version_required=True,
    ...
    EventFamilyDefinition(
        ...
        producer_service="portfolio_derived_state_service",
        consumer_services=(),
        runtime_active=False,
        idempotency_required=True,
        correlation_required=True,
...
DIRECT_KAFKA_TOPIC_DEFINITIONS: tuple[DirectKafkaTopicDefinition, ...] = (
    ...
    DirectKafkaTopicDefinition(
        ...
        producer_service="ingestion_service",
        consumer_services=("persistence_service",),
        payload_contract="RawTransactionEvent",
        idempotency_header_supported=True,
        correlation_header_supported=True,
        supportability_evidence=(INGESTION_EVIDENCE_BUNDLE,),
        source_data_products=("TransactionLedgerWindow", "HoldingsAsOf"),
    ...
    DirectKafkaTopicDefinition(
        ...
        producer_service="ingestion_service,portfolio_transaction_processing_service",
        consumer_services=("persistence_service",),
    ...
    DirectKafkaTopicDefinition(
        ...
        consumer_services=("portfolio_transaction_processing_service",),
        payload_contract="transaction_reprocessing_command",
        idempotency_header_supported=True,
        correlation_header_supported=True,
        supportability_evidence=(INGESTION_EVIDENCE_BUNDLE,),
        source_data_products=("TransactionLedgerWindow", "HoldingsAsOf"),
    ...
    DirectKafkaTopicDefinition(
        ...
        consumer_services=("position_valuation_calculator",),
