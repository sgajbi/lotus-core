...
KAFKA_FX_RATES_PERSISTED_TOPIC = os.getenv("KAFKA_FX_RATES_PERSISTED_TOPIC", "fx_rates.persisted")
...
CASHFLOW_RULE_CACHE_SOURCE_VERSION_CHECK_INTERVAL_SECONDS = _env_int(
...
KAFKA_CONSUMER_RETRYABLE_FAILURE_MAX_ATTEMPTS = _env_int(
    "KAFKA_CONSUMER_RETRYABLE_FAILURE_MAX_ATTEMPTS",
    0,
    minimum=0,
)
KAFKA_CONSUMER_RETRYABLE_FAILURE_MAX_ELAPSED_SECONDS = _env_int(
