...
SOURCE_DATA_PRODUCT_CATALOG: tuple[SourceDataProductDefinition, ...] = (
    SourceDataProductDefinition(
        ...
        owner="lotus-core",
        consumers=("lotus-gateway", "lotus-advise", "lotus-manage", "lotus-risk", "lotus-idea"),
    ...
    SourceDataProductDefinition(
        ...
        serving_plane=QUERY_SERVICE,
        owner="lotus-core",
        consumers=("lotus-gateway", "lotus-report", "lotus-manage", "lotus-idea"),
    ...
    SourceDataProductDefinition(
        ...
        serving_plane=QUERY_CONTROL_PLANE_SERVICE,
        owner="lotus-core",
        consumers=("lotus-performance", "lotus-risk", "lotus-report", "lotus-manage", "lotus-idea"),
