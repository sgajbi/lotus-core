"""Resolve canonical transaction fee components and aggregate trade fees."""

from decimal import Decimal
from typing import Mapping

from ..decimal_amount import decimal_or_none
...
def _optional_fee_amount(value: object, *, field_name: str) -> Decimal | None:
    if value is None:
        return None
    normalized_amount: Decimal | None = decimal_or_none(value)
