...
.PHONY: ingestion-gateway-rate-limit-policy-guard generated-artifact-tracking-guard technology-governance-pilot-guard technology-governance-pilot-receipt-guard dependency-lock-replay-check dependency-technology-inventory dependency-technology-certify refresh-dependency-technology-inventory base-image-lifecycle-guard refresh-base-image-manifest-evidence outbox-capacity-profile-guard test-outbox-capacity-acceptance
