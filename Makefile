...
lint:
	...
	python -m ruff check src/libs/portfolio-common/portfolio_common/runtime_providers.py src/services/financial_reconciliation_service/app/services/runtime_providers.py src/services/financial_reconciliation_service/app/services/reconciliation_service.py src/services/query_control_plane_service/app/application/core_snapshot/service.py src/services/query_control_plane_service/app/application/simulation.py scripts/quality/runtime_provider_port_guard.py tests/unit/libs/portfolio-common/test_runtime_providers.py tests/unit/services/financial_reconciliation_service/test_reconciliation_service.py tests/unit/services/query_control_plane_service/application/core_snapshot/test_core_snapshot_service.py tests/unit/services/query_control_plane_service/application/test_simulation.py tests/unit/scripts/test_runtime_provider_port_guard.py --ignore E501,I001
	...
	python -m ruff format --check src/libs/portfolio-common/portfolio_common/runtime_providers.py src/services/financial_reconciliation_service/app/services/runtime_providers.py src/services/financial_reconciliation_service/app/services/reconciliation_service.py src/services/query_control_plane_service/app/application/core_snapshot/service.py src/services/query_control_plane_service/app/application/simulation.py scripts/quality/runtime_provider_port_guard.py tests/unit/libs/portfolio-common/test_runtime_providers.py tests/unit/services/financial_reconciliation_service/test_reconciliation_service.py tests/unit/services/query_control_plane_service/application/core_snapshot/test_core_snapshot_service.py tests/unit/services/query_control_plane_service/application/test_simulation.py tests/unit/scripts/test_runtime_provider_port_guard.py
