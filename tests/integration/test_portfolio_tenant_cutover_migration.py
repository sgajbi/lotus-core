...
UNRELATED_REUSED_CORRELATION_AUDIT_INSERT = text(
    """
    INSERT INTO enterprise_security_audit_events (
        event_id, occurred_at, component, route_template, method, decision, reason,
        service_identity, actor_id, tenant_id, role, identity_posture,
        correlation_id, trace_id, policy_version
    ) VALUES (
