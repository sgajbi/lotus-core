...
async def test_load_corporate_action_group_maps_rows_to_domain_transactions() -> None:
...
async def test_save_corporate_action_evidence_maps_typed_records_inside_repository() -> None:
    db_session = AsyncMock()
    repository = CostCalculatorRepository(db_session)
