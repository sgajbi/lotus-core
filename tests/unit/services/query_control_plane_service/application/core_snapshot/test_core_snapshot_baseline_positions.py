...
from src.services.query_control_plane_service.app.application.core_snapshot.baseline_positions import (  # noqa: E501
...
def _source(row: SimpleNamespace, instrument: CoreSnapshotInstrument) -> CoreSnapshotPositionSource:
...
def test_baseline_position_entries_normalizes_security_ids_and_sorts() -> None:
    entries = baseline_position_entries(
        rows=[
            _source(_snapshot_row(" SEC_B "), _instrument("SEC_B")),
