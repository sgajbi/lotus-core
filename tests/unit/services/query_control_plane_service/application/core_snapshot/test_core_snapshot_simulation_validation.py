...
from src.services.query_control_plane_service.app.application.core_snapshot.simulation_validation import (  # noqa: E501
...
async def test_simulation_session_validator_returns_matching_session() -> None:
    ...
    validator = CoreSnapshotSimulationSessionValidator(simulation_store=simulation_repo)
...
async def test_simulation_session_validator_requires_simulation_options() -> None:
    validator = CoreSnapshotSimulationSessionValidator(simulation_store=AsyncMock())
