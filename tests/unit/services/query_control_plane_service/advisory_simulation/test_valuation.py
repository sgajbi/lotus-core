...
from src.services.query_control_plane_service.app.application.advisory_simulation.allocation_contract import (  # noqa: E501
    ADVISORY_PROPOSAL_ALLOCATION_DIMENSIONS,
)
from src.services.query_control_plane_service.app.application.advisory_simulation.valuation import (
    ValuationService,
