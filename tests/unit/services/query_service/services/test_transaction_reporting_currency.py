...
def test_source_currency_for_transaction_field_prefers_trade_currency_for_trade_basis() -> None:
    ...
    assert source_currency_for_transaction_field(record=record, currency_basis="trade") == "EUR"
    assert source_currency_for_transaction_field(record=record, currency_basis="book") == "USD"
