...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("SPLIT", "4", Decimal("4")),
        ("BONUS_ISSUE", "1.5", Decimal("1.5")),
        ("STOCK_DIVIDEND", "2.25", Decimal("2.25")),
        ("RIGHTS_ALLOCATE", "3", Decimal("3")),
        ("RIGHTS_SHARE_DELIVERY", "4", Decimal("4")),
        ("SELL", "7", Decimal("-7")),
        ...
        ("REVERSE_SPLIT", "1.5", Decimal("-1.5")),
        ("CONSOLIDATION", "2", Decimal("-2")),
        ("RIGHTS_SUBSCRIBE", "3", Decimal("-3")),
        ("RIGHTS_OVERSUBSCRIBE", "1", Decimal("-1")),
        ("RIGHTS_SELL", "2", Decimal("-2")),
        ("RIGHTS_EXPIRE", "1", Decimal("-1")),
        ("DEPOSIT", "5", Decimal("0")),
