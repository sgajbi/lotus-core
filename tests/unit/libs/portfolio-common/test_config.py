...
def test_active_topic_registry_has_explicit_source_owned_partition_counts():
    ...
    assert config_module.KAFKA_TOPIC_PARTITION_COUNTS["transactions.raw.received"] == 14
    assert config_module.KAFKA_TOPIC_PARTITION_COUNTS["transactions.persisted"] == 14
