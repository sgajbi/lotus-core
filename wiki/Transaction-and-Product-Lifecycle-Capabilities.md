...
| Bond maturity, call, or partial redemption | Limited | Core books governed quantity/lot depletion, net principal-component cashflow, separate linked accrued-interest income, authoritative net settlement cash, capital/FX P&L, explicit or factor-based partials, and immutable source-lot receipts. Release certification and wider multi-source AVCO capacity remain pending. | [#477](https://github.com/sgajbi/lotus-core/issues/477), [#481](https://github.com/sgajbi/lotus-core/issues/481) |
