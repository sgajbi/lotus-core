...
| `DataQualityCoverageReport:v1` | `/integration/benchmarks/{benchmark_id}/coverage`, `/integration/reference/risk-free-series/coverage` | Deterministic benchmark-component and risk-free observation coverage, missing-date, quality, freshness, and lineage diagnostics. | QCP owns the contracts, coverage policies, typed source ports, SQL adapters, source proof, composition, and routes. The Query Service coverage facade, builders, calculations, and repository methods are retired; PR/mainline validation remains pending under issue `#460`. |
