...
| --- | --- | --- |
| `DpmModelPortfolioTarget:v1` | `/integration/model-portfolios/{model_portfolio_id}/targets` | Model weights, target bands, and cash reserve policy for a governed discretionary mandate model. |
