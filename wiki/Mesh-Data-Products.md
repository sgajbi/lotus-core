...
`ExternalHedgeExecutionReadiness:v1` are active only as fail-closed unavailable runtime postures:
...
or autonomous treasury action from the current posture. `ExternalEligibleHedgeInstrument:v1`
remains a planned domain product only.
