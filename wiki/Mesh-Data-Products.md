...
| `DpmPortfolioUniverseCandidate:v1` | `/integration/dpm/portfolio-universe/candidates` | Paged source-owned DPM portfolio-universe candidate discovery from effective discretionary mandate bindings, with as-of, booking-center, model-portfolio, active-authority, continuation-token, supportability, snapshot, and lineage evidence. | Implemented locally for RFC37-WTBD-004 source-owner depth. It deliberately does not claim relationship-householding, suitability approval, PM ranking, execution readiness, client communication workflow, or external workflow ownership. Downstream `lotus-manage` consumption and live canonical wave proof remain separate work before end-to-end production proof is claimed. |
...
does not close broader source-product depth by itself; downstream `lotus-manage` consumption,
front-office canonical wave proof, and any non-Core source-owner products remain separate slices.
