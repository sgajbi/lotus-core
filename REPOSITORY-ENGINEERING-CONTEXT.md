...
9. RFC-0083 Slice 6 now defines the priority source-data product catalog, product metadata requirements, consumer map, paging/export disposition, route metadata bindings, DTO-envelope product identity, HoldingsAsOf, TransactionLedgerWindow, and PortfolioStateSnapshot runtime supportability metadata, and a linted source-data product contract guard,
