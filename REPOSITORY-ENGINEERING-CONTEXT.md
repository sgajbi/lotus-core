...
22. Boundary mapping conformance now has a repo-native command,
    ...
    longer requires an API-router boundary exception. The query-service BUY and SELL state routers
    now use dependency-module service providers and no longer require #638 exceptions.
