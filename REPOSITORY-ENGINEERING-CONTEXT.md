...
- Tenant S1 is complete, but #798 S2-S6 remain open. Do not claim estate-wide tenant isolation until
  stateful fences, ledger and derived records, query paths, replay, and operations are tenant-bound
  and exact-main proven.
