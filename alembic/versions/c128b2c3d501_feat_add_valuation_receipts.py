...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("policy_assignment_source", sa.JSON(), nullable=True),
        ...
        sa.Column("market_price_source", sa.JSON(), nullable=True),
        sa.Column("calculation_lineage", sa.JSON(), nullable=True),
