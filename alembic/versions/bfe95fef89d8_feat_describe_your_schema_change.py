...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_market_prices_security_id"), "market_prices", ["security_id"], unique=False
    )
    op.create_table(
        "outbox_events",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(
        op.f("ix_portfolio_aggregation_jobs_aggregation_date"),
        "portfolio_aggregation_jobs",
        ["aggregation_date"],
        unique=False,
    )
    op.create_index(
        op.f("ix_portfolio_aggregation_jobs_portfolio_id"),
        "portfolio_aggregation_jobs",
        ["portfolio_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_portfolio_aggregation_jobs_status"),
        "portfolio_aggregation_jobs",
        ["status"],
        unique=False,
    )
    op.create_table(
        ...
        sa.UniqueConstraint(
            ...
            "security_id",
            "valuation_date",
            name="_portfolio_security_valuation_date_uc",
        ),
    )
    op.create_index(
        op.f("ix_portfolio_valuation_jobs_portfolio_id"),
        "portfolio_valuation_jobs",
        ["portfolio_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_portfolio_valuation_jobs_security_id"),
        "portfolio_valuation_jobs",
        ["security_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_portfolio_valuation_jobs_status"),
        "portfolio_valuation_jobs",
        ["status"],
        unique=False,
    )
    op.create_index(
        op.f("ix_portfolio_valuation_jobs_valuation_date"),
        "portfolio_valuation_jobs",
        ["valuation_date"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_recalculation_jobs_portfolio_id"),
        "recalculation_jobs",
        ["portfolio_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_recalculation_jobs_security_id"),
        "recalculation_jobs",
        ["security_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_recalculation_jobs_status"), "recalculation_jobs", ["status"], unique=False
    )
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "portfolio_id", "security_id", "date", name="_portfolio_security_date_uc"
        ),
    )
    op.create_index(
        "ix_daily_position_snapshots_covering",
        "daily_position_snapshots",
        ["portfolio_id", "security_id", sa.text("date DESC"), sa.text("id DESC")],
        unique=False,
    )
    op.create_index(
        op.f("ix_daily_position_snapshots_date"), "daily_position_snapshots", ["date"], unique=False
    )
    op.create_index(
        op.f("ix_daily_position_snapshots_portfolio_id"),
        "daily_position_snapshots",
        ["portfolio_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_daily_position_snapshots_security_id"),
        "daily_position_snapshots",
        ["security_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_daily_position_snapshots_valuation_status"),
        "daily_position_snapshots",
        ["valuation_status"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_transactions_portfolio_security",
        "transactions",
    ...
    op.create_index(
        op.f("ix_cashflows_cashflow_date"), "cashflows", ["cashflow_date"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_position_history_portfolio_id"), "position_history", ["portfolio_id"], unique=False
    )
    op.create_index(
        op.f("ix_position_history_position_date"),
        "position_history",
        ["position_date"],
        unique=False,
    )
    op.create_index(
        op.f("ix_position_history_security_id"), "position_history", ["security_id"], unique=False
    )
    op.create_table(
        "transaction_costs",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_daily_position_snapshots_valuation_status"), table_name="daily_position_snapshots"
    )
    op.drop_index(
        op.f("ix_daily_position_snapshots_security_id"), table_name="daily_position_snapshots"
    )
    op.drop_index(
        op.f("ix_daily_position_snapshots_portfolio_id"), table_name="daily_position_snapshots"
    )
    ...
    op.drop_index(
        op.f("ix_portfolio_valuation_jobs_valuation_date"), table_name="portfolio_valuation_jobs"
    )
    op.drop_index(op.f("ix_portfolio_valuation_jobs_status"), table_name="portfolio_valuation_jobs")
    op.drop_index(
        op.f("ix_portfolio_valuation_jobs_security_id"), table_name="portfolio_valuation_jobs"
    )
    op.drop_index(
        op.f("ix_portfolio_valuation_jobs_portfolio_id"), table_name="portfolio_valuation_jobs"
    )
    op.drop_table("portfolio_valuation_jobs")
    op.drop_index(
        op.f("ix_portfolio_aggregation_jobs_status"), table_name="portfolio_aggregation_jobs"
    )
    op.drop_index(
        op.f("ix_portfolio_aggregation_jobs_portfolio_id"), table_name="portfolio_aggregation_jobs"
    )
    op.drop_index(
        op.f("ix_portfolio_aggregation_jobs_aggregation_date"),
